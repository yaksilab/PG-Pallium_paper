%% Determining the responding and reliable neurons following sensory stimulation (Function for Fig.2)
...
for choice =1:2
    for fish={'fish1','fish2','fish3','fish4','fish5','fish6','fish7','fish8','fish9','fish10','fish11'}
        ...
        [positive_resp_cells,negative_resp_cells]=RespondingCells_InVivo(traces,frame_rate,n_stim,response_time);
