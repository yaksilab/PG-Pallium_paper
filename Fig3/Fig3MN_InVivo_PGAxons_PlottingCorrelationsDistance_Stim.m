%% Plotting the Pairwise correlations as a function of distance during sensory stimulation (Fig. 3M, 3N)
%This scripts plots the parwise pixel-to-pixel correlations for all Pallial PG axonal pixels as a function of distance between pixel pairs during sensory stimulation.
...
for fish={'fish1','fish2','fish3','fish4','fish5','fish6','fish7','fish8','fish9','fish10','fish11','fish12'}
    temp3=spatialCorr.PGAxons.(fish{1}).leftHemi.LStim.distShufCorr;
    temp4=spatialCorr.PGAxons.(fish{1}).rightHemi.LStim.distShufCorr;
    distShufCorrL=[distShufCorrL;temp3;temp4];
    temp5=spatialCorr.PGAxons.(fish{1}).leftHemi.TStim.distShufCorr;
    temp6=spatialCorr.PGAxons.(fish{1}).rightHemi.TStim.distShufCorr;
...
distCorrT=[];
for fish={'fish1','fish2','fish3','fish4','fish5','fish6','fish7','fish8','fish9','fish10','fish11','fish12'}
    temp3=spatialCorr.PGAxons.(fish{1}).leftHemi.LStim.distCorr;
    temp4=spatialCorr.PGAxons.(fish{1}).rightHemi.LStim.distCorr;
    distCorrL=[distCorrL;temp3;temp4];
    temp5=spatialCorr.PGAxons.(fish{1}).leftHemi.TStim.distCorr;
    temp6=spatialCorr.PGAxons.(fish{1}).rightHemi.TStim.distCorr;
...
%% Plotting the figure for the Light responding period (Fig. 3M)
...
%% Plotting the figure for the Vibration responding period (Fig. 3N)
%defining the bin size for the x axis
steps = floor(linspace(0,200,51));  
