%% Analyzing the pairwise correlations between two spontaneous periods (Fig. 3G)
...
%This is for all PG neurons in all fish (N=12). 
...
for fish={'fish1','fish2','fish3','fish4','fish5','fish6','fish7','fish8','fish9','fish10','fish11','fish12'} %for LightTap
    all_pairs_Corr=[];
    all_pairs_pVal=[];
    
    temp_corr1=spatialCorr.PGAxons.(fish{1}).leftHemi.spontPeriod1.CorrMat;
    temp_corr2=spatialCorr.PGAxons.(fish{1}).leftHemi.spontPeriod2.CorrMat;
    temp_corr3=spatialCorr.PGAxons.(fish{1}).rightHemi.spontPeriod1.CorrMat;
    temp_corr4=spatialCorr.PGAxons.(fish{1}).rightHemi.spontPeriod2.CorrMat;

    temp_pVal1=spatialCorr.PGAxons.(fish{1}).leftHemi.spontPeriod1.PVal_Mat;
    temp_pVal2=spatialCorr.PGAxons.(fish{1}).leftHemi.spontPeriod2.PVal_Mat;
    temp_pVal3=spatialCorr.PGAxons.(fish{1}).rightHemi.spontPeriod1.PVal_Mat;
    temp_pVal4=spatialCorr.PGAxons.(fish{1}).rightHemi.spontPeriod2.PVal_Mat;
