%% Plotting the Pairwise correlations as a function of distance (Fig. 3E, fig. S7C)
%This scripts plots the parwise pixel-to-pixel correlations for all pallial PG axons as a function of distance between axonal pixel pairs.
%This script needs to be run by individual section.
%Adapted from Bartoszek et al., 2021 & Ostenrath et al., 2025

%Input:
% Analysis file: 202606_PGAxons_SpatialCorr.mat
...
fileName_data = '202606_PGAxons_SpatialCorr.mat';
...
for fish={'fish1','fish2','fish3','fish4','fish5','fish6','fish7','fish8','fish9','fish10','fish11','fish12'}
    temp=spatialCorr.PGAxons.(fish{1}).leftHemi.spontAll.distShufCorr;
    temp2=spatialCorr.PGAxons.(fish{1}).rightHemi.spontAll.distShufCorr;
...
distCorr=[];
for fish={'fish1','fish2','fish3','fish4','fish5','fish6','fish7','fish8','fish9','fish10','fish11','fish12'}
    temp=spatialCorr.PGAxons.(fish{1}).leftHemi.spontAll.distCorr;
    temp2=spatialCorr.PGAxons.(fish{1}).rightHemi.spontAll.distCorr;
    distCorr=[distCorr;temp;temp2];
end

distPosCorr=[];
for fish={'fish1','fish2','fish3','fish4','fish5','fish6','fish7','fish8','fish9','fish10','fish11','fish12'}
    temp=spatialCorr.PGAxons.(fish{1}).leftHemi.spontAll.distPosCorr;
    temp2=spatialCorr.PGAxons.(fish{1}).rightHemi.spontAll.distPosCorr;
    distPosCorr=[distPosCorr;temp;temp2];
end

distNegCorr=[];
for fish={'fish1','fish2','fish3','fish4','fish5','fish6','fish7','fish8','fish9','fish10','fish11','fish12'}
    temp=spatialCorr.PGAxons.(fish{1}).leftHemi.spontAll.distNegCorr;
    temp2=spatialCorr.PGAxons.(fish{1}).rightHemi.spontAll.distNegCorr;
...
%% Plotting the figures (Fig 3E and fig. S7C)
...
%Making the figure for the entire spontaneous ongoing period - 8 mins for all correlations (Fig. 4E)
f1=figure;
...
%Making the figure for the entire spontaneous ongoing period - 8 mins, seperating the positive and negative correlations (Suppl. fig. 5C)
f2=figure;
