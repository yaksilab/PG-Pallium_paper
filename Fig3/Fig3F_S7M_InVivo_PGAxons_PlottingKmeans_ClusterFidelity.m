%% Plots the Cluster fidelity percentages for the PG Axons as a bar graph (Fig. 3F, S7M)
...
%Input:
% Analysis file: 202606_PGAxons_AnalysisKmeanss.mat
...
load(analysis_path);
%% Plotting the Bargraph for Spontaenous (ongoing) data (Fig. 4F)
...
%% Plotting the Bargraph for Stim data (Suppl. fig. 7M)
